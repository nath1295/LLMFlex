Module llmflex.Frontend.gradio_interface
========================================

Classes
-------

`GradioInterface(model: llmflex.Models.Factory.llm_factory.LlmFactory, embeddings: Type[llmflex.Embeddings.base_embeddings.BaseEmbeddingsToolkit])`
:   
